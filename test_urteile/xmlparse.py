...
# we need the length to calculate the percentage done; same goes for counter 
	...
	for xml in xmllist:
		...
		OLG_Düsseldorf = listcount(doknrlist, 'OLG Düsseldorf')
		...
		OLG_Koblenz = listcount(doknrlist, 'OLG Koblenz')
		...
		OLG_Bremen = listcount(doknrlist, 'OLG Bremen')
		...
		Thomas_Putzo = listcount(doknrlist, 'Thomas/Putzo')
